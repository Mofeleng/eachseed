  ...
  return (
    <div className="flex flex-row items-center justify-center py-10 h-screen md:h-auto relative w-full">
      <div className="w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
         <CustomHeading
              heading="Shape a sustainable future today"
              paragraph="Join us in funding innovative solutions for a better tomorrow. Whether you're launching a project or backing one, be part of the change."
            />
        </motion.div>
