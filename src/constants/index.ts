...
export const howItWorksArray = [
    {
        ...
        description: "Browse a curated selection of sustainable businesses across industries like renewable energy, green tech, and social enterprises. Filter by category, impact goals, or funding status to find opportunities that align with your values"
    },
    {
